...
-- inserting into tFreinds
 insert into tFreinds values(101,102);
 insert into tFreinds values(101,103);
 insert into tFreinds values(102,101);
 insert into tFreinds values(102,105);
 insert into tFreinds values(102,103);
 insert into tFreinds values(103,105);
 insert into tFreinds values(104,101);
 insert into tFreinds values(104,103);
 insert into tFreinds values(105,102);
...
select * from tWall where user_id in (select user_id from tUser where Name="Bharath");
-- or
